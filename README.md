#Projeto Final da cadeira de Eletrónica Digital e Microprocessadores  
<p>Este projeto consiste na utilização de 3 *Application Programming Interface*, nomeadamente, a API do <i>World Time</i>, a API do <i>OpenWeather</i> e a API do index ultravioleta que também pertence ao Open Weather.  
